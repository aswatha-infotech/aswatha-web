...
const colorGroups = [
  {
    name: "Gloss",
    options: [
      { name: "Pearl White", value: "#fff" },
      { name: "Turquoise Blue", value: "#0077ad" },
    ],
  },
  {
    name: "Matte",
    options: [
      { name: "Matte Red", value: "#c12830" },
      { name: "Purple", value: "#644575" },
      { name: "Matte Black", value: "#202021" },
      { name: "Matte Blue", value: "#0043a9"},
    ],
  },
  {
    name: "SXC",
    ...
    <div className="bg-slate-100 text-slate-900">
      ...
      <main className="pt-18">
        <section className="relative">
          <img src="/img/HERO/22.webp" alt="TVS Apache RTX hero" className="h-auto w-full object-contain" />
        </section>
